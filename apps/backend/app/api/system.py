...
_CATALOG: list[dict] = [
    ...
    {
        "id": "findb_metadata_full",
        "allow_manual": True,
        "source": "findb COS full",
        "label": "findb core 元数据全量",
        "schedule": "仅手动触发",
        "tables": [
            "instrument_master",
            "data_coverage",
    ...
    },
    {
        ...
        "allow_manual": True,
        "source": "findb COS full",
        "label": "findb 全量 data pool 初始化",
        "schedule": "仅手动触发（重任务）",
        "tables": ["instrument_master", "data_coverage", "data_pool_state"],
        "maintenance": True,
    },
    {
        "id": "minute_kline",
    ...
    {
        "id": "minute_storage_migration",
        "allow_manual": True,
        "source": "本地维护",
        "label": "分钟K旧增量迁移",
        "schedule": "仅手动触发一次",
        "tables": ["data_coverage"],
        "maintenance": True,
    },
    {
